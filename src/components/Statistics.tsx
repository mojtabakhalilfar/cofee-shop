    ...
    return (
        <div className='flex items-center justify-center w-full relative'>
            <div style={{ backgroundImage: "url('/assets/Vector.png')" }} className="bg-contain bg-no-repeat bg-center flex items-center justify-center w-[80%] h-[240px]">
                ...
                <div className='absolute bottom-[-250px] sm:bottom-[-155px] w-[340px] sm:w-[1000px] h-[250px] sm:h-[155px] rounded-[20px] bg-[url(/assets/backgroundeStatist.png)] p-4 sm:py-8 grid grid-cols-2 sm:grid-cols-4'>
                    {amar.map((items) => (
