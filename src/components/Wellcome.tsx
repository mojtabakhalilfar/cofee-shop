...
const Wellcome = () => {
    return (
        <div dir='rtl' className='w-full flex flex-col items-center py-20'>
            <p className='font-normal text-[45px] sm:text-[85px] leading-[45pxpx] sm:leading-[85px] text-[rgba(36,36,36,1)] w-4/ text-center5'><span className='font-bold text-[45px] sm:text-[85px] leading-[45pxpx] sm:leading-[85px] text-[rgba(79,44,25,1)]'> قهوه</span> یادت نره!</p>
